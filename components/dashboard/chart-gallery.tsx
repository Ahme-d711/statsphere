...
export const ChartGallery = ({ chartsData }: ChartGalleryProps) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
      {chartsData.bar && chartsData.bar.length > 0 && (
        <motion.div
        ...
        >
          <Card className="bg-card/40 backdrop-blur-md border-muted-foreground/10 rounded-2xl overflow-hidden shadow-xl shadow-primary/5">
            ...
            <CardContent className="h-[300px] min-h-[300px] w-full pt-4">
      ...
      {chartsData.line && chartsData.line.length > 0 && (
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
      ...
      {chartsData.pie && chartsData.pie.length > 0 && (
        <motion.div
      ...
      {chartsData.breakdown && chartsData.breakdown.length > 0 && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
